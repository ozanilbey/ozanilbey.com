...
// Content: Work Summary > 101 Extra Ads - Glow (Item)
const _101ExtraAdsGlow = () => (
  <>
    <Container isBlockLayout>
      <Media type="image" width={864} source="/101-extra-ads-glow/teaser.png" />
    ...
    <Container isBlockLayout>
      ...
      <Media type="image" width={1152} source="/101-extra-ads-glow/01.png" />
      <Media type="image" width={1152} source="/101-extra-ads-glow/02.png" />
      <Media type="image" width={1152} source="/101-extra-ads-glow/03.png" />
      <Media type="image" width={1152} source="/101-extra-ads-glow/04.png" />
      <Media type="image" width={1152} source="/101-extra-ads-glow/05.png" />
    </Container>
  </>
)

// Export
export default _101ExtraAdsGlow
