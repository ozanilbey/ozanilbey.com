  ...
  return (
    <Page.Section
      ...
      <Container>
        ...
        <p className="link lead">If you’d like to see more, <Link type="cta" to="/works">browse my portfolio</Link></p>
      </Container>
    </Page.Section>
  )
}
