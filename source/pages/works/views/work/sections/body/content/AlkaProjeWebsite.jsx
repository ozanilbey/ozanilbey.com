    ...
    <>
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/alka-proje-website/01.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/02.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/03.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/04.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/05.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/06.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/07.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/08.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/alka-proje-website/09.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/alka-proje-website/10.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/alka-proje-website/11.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/alka-proje-website/12.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/alka-proje-website/13.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/alka-proje-website/14.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/alka-proje-website/15.png" />
      </Content>
    </>
  )
}
