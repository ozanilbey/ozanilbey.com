    ...
    <>
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/waplog-web-application/01.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/02.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/03.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/04.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/05.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/06.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/07.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/08.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/09.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/10.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/11.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/12.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/13.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/14.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/15.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/16.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/17.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/18.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/19.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          path="/waplog-web-application/20.png" />
      </Content>
    </>
  )
}
