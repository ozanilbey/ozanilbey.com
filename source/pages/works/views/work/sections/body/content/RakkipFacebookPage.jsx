    ...
    <>
      <Content>
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/teaser.png" />
        <p>Rakkip is a <strong>social game</strong>, based on traditional Turkish game Okey, developed and managed by Digitoy Games. It is available on Apple Store, Google Play Store, and Facebook.</p>
        <p>I designed 8 different Facebook post templates for Rakkip <strong>in 2016</strong>. Each of these templates serves different purposes.</p>
        <Callout
          size="large"
          intent="information"
          hasBackground={false}
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/01.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/02.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/03.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/04.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/05.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/06.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/07.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/08.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/09.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/10.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/11.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/12.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/13.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/14.png" />
        <Media
          width={640}
          type="image"
          className="media"
          path="/rakkip-facebook-page/15.png" />
      </Content>
      <Content>
        <Heading
          rank={2}
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/rakkip-facebook-page/16.png" />
        <Media
          width={768}
          type="image"
          className="media"
          path="/rakkip-facebook-page/17.png" />
      </Content>
    </>
  )
}
