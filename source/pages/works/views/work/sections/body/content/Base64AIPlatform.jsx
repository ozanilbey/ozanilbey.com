    ...
    <>
      ...
      <Content>
        ...
        <Media
          ...
          type="video"
          className="media"
          path="/base64-ai-platform/01.mov" />
        <small className="note">Demo</small>
        <Media
          width={1152}
          type="image"
          className="media"
          path="/base64-ai-platform/02.png" />
        <small className="note">Idle</small>
        <Media
          width={1152}
          type="image"
          className="media"
          path="/base64-ai-platform/03.png" />
        <small className="note">Filtering</small>
        <Media
          width={1152}
          type="image"
          className="media"
          path="/base64-ai-platform/04.png" />
        <small className="note">Processing/Results</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/05.png" />
      ...
      <Content>
        ...
        <Media
          ...
          type="video"
          className="media"
          path="/base64-ai-platform/06.mov" />
        <small className="note">Demo</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/07.png" />
        <small className="note">Splash screen</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/08.png" />
        <small className="note">Idle</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/09.png" />
        <small className="note">Processing</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/10.png" />
        <small className="note">Results (preview)</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/11.png" />
        <small className="note">Results (expanded)</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/base64-ai-platform/12.png" />
