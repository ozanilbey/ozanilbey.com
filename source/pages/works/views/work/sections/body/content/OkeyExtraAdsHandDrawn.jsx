    ...
    <>
      <Content>
        <Media
          ...
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/teaser.png" />
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/01.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/02.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/03.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/04.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/okey-extra-ads-hand-drawn/05.png" />
      </Content>
    </>
  )
}
