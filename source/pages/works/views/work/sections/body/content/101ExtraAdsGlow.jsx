...
// Content: Works > Work > Body > 101 Extra ads - glow
function _101ExtraAdsGlow () {
  return (
    <>
      <Content>
        <Media
          ...
          type="image"
          className="media"
          path="/101-extra-ads-glow/teaser.png" />
        ...
        <p>I designed advertisement visuals for 101 Extra <strong>in 2017</strong>. All images are used on Facebook as sponsored content.</p>
        <Callout
          size="large"
          intent="information"
          hasBackground={false}
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/101-extra-ads-glow/01.png" />
        <Media
          width={768}
          type="image"
          className="media"
          path="/101-extra-ads-glow/02.png" />
        <Media
          width={768}
          type="image"
          className="media"
          path="/101-extra-ads-glow/03.png" />
        <Media
          width={768}
          type="image"
          className="media"
          path="/101-extra-ads-glow/04.png" />
        <Media
          width={768}
          type="image"
          className="media"
          path="/101-extra-ads-glow/05.png" />
      </Content>
    </>
  )
}
