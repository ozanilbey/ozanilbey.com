    ...
    <>
      <Content>
        <Media
          ...
          type="image"
          className="media"
          source="/101-extra-ads-glow/teaser.png" />
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          source="/101-extra-ads-glow/01.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/101-extra-ads-glow/02.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/101-extra-ads-glow/03.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/101-extra-ads-glow/04.png" />
        <Media
          width={1152}
          type="image"
          className="media"
          source="/101-extra-ads-glow/05.png" />
      </Content>
    </>
  )
}
