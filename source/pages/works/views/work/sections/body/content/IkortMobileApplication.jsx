    ...
    <>
      ...
      <Content>
        ...
        <Media
          ...
          type="image"
          className="media"
          path="/ikort-mobile-application/01.png" />
        <small className="note">Login Page</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/02.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/03.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/04.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/05.png" />
        <small className="note">Sliding Menu</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/06.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/07.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/08.png" />
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/09.png" />
        <small className="note">Overlay</small>
        <Media
          width={384}
          type="image"
          className="media"
          path="/ikort-mobile-application/10.png" />
      </Content>
    </>
  )
}
