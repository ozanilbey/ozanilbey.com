  ...
  return (
    <>
      <Content>
        ...
        <p>I worked at Base64.ai as <strong>the #1 employee</strong>. I designed <strong>a really simple brand identity</strong> and related brand materials for Base64.ai in <strong>2020</strong>.</p>
        <Callout
          size="large"
          intent="information"
          hasBackground={false}
